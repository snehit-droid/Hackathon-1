        ...
        for(let i=0; i < color_val.length; i++) { 
          if(i==0){
            ...
            if(color_val[i] == 2 || color_val[i] == 3){
                //let c1 = document.getElementById('circ_2');
...
function pick_4(){
    ...
    function evaluate(){
        ...
        if(a.style.backgroundColor.value == rgb(255, 0, 0)){
            user_ans.push(1); 
        }
        if(a.style.backgroundColor.value == rgb(62, 179, 7)){
            user_ans.push(3); 
        }
        if(a.style.backgroundColor.value == rgb(103, 21, 170)){
            user_ans.push(5); 
        }
        if(a.style.backgroundColor.value == rgb(148, 26, 128)){
            user_ans.push(7); 
        }
        if(a.style.backgroundColor.value == rgb(10, 252, 1)){
            user_ans.push(8); 
        }
        if(a.style.backgroundColor.value == rgb(199, 10, 10)){
            user_ans.push(9); 
        }

        let b = document.getElementById("circ_2");
        if(b.style.backgroundColor.value == rgb(255, 0, 0)){
            user_ans.push(1); 
        }
        if(b.style.backgroundColor.value == rgb(62, 179, 7)){
            user_ans.push(3); 
        }
        if(b.style.backgroundColor.value == rgb(103, 21, 170)){
            user_ans.push(5); 
        }
        if(b.style.backgroundColor.value == rgb(148, 26, 128)){
            user_ans.push(7); 
        }
        if(b.style.backgroundColor.value == rgb(10, 252, 1)){
            user_ans.push(8); 
        }
        if(b.style.backgroundColor.value == rgb(199, 10, 10)){
            user_ans.push(9); 
        }

        let c = document.getElementById("circ_3");
        if(c.style.backgroundColor.value == rgb(255, 0, 0)){
            user_ans.push(1); 
        }
        if(c.style.backgroundColor.value == rgb(62, 179, 7)){
            user_ans.push(3); 
        }
        if(c.style.backgroundColor.value == rgb(103, 21, 170)){
            user_ans.push(5); 
        }
        if(c.style.backgroundColor.value == rgb(148, 26, 128)){
            user_ans.push(7); 
        }
        if(c.style.backgroundColor.value == rgb(10, 252, 1)){
            user_ans.push(8); 
        }
        if(c.style.backgroundColor.value == rgb(199, 10, 10)){
            user_ans.push(9); 
        }

        let d = document.getElementById("circ_4");
        if(d.style.backgroundColor.value == rgb(255, 0, 0)){
            user_ans.push(1); 
        }
        if(d.style.backgroundColor.value == rgb(62, 179, 7)){
            user_ans.push(3); 
        }
        if(d.style.backgroundColor.value == rgb(103, 21, 170)){
            user_ans.push(5); 
        }
        if(d.style.backgroundColor.value == rgb(148, 26, 128)){
            user_ans.push(7); 
        }
        if(d.style.backgroundColor.value == rgb(10, 252, 1)){
            user_ans.push(8); 
        }
        if(d.style.backgroundColor.value == rgb(199, 10, 10)){
            user_ans.push(9); 
        }
